      ...
      <div className="relative bg-navy-900 w-full sm:max-w-md sm:rounded-2xl rounded-t-2xl max-h-[90vh] overflow-y-auto border border-white/10">
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div className="flex items-start gap-3">
            <div className="w-14 h-14 rounded-xl bg-navy-700 flex items-center justify-center flex-shrink-0 border border-white/5">
              <span className="text-2xl">{getFoodIcon(name, category)}</span>
            </div>
